...
var dell_analyzer_1 = __importDefault(require("./lee/dell-analyzer"));
var Common = /** @class */ (function () {
    function Common(url, analyzer) {
        this.url = url;
    ...
    // 这里爬取到html
    Common.prototype.getRawHtml = function () {
    ...
    // 写入文件操作
    Common.prototype.writeFile = function (content) {
        fs_1.default.writeFileSync(this.filePath, content);
    };
    // 初始化
    Common.prototype.initSpiderProcess = function () {
        return __awaiter(this, void 0, void 0, function () {
...
var analyze = new dell_analyzer_1.default();
